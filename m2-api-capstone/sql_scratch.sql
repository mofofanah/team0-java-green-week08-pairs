...
SELECT transfers.transfer_id, transfers.transfer_type_id, transfers.transfer_status_id, transfers.account_from, u3.username, transfers.account_to, u2.username, transfers.amount 
FROM users u1
